...
import './index.css';
const MyVideos:React.FC<any> = ({showMyModal, setShowLoading, setShowAlertState})=>{
    ...
    const pullMyVideos = useCallback((callback, direction)=>{
        ...
        var requestObj = {
            method: "GET", 
            url: localDomain("api/adminStream?appType=videos&action=pullVideos&listSize=10&direction="+direction+"&startFrom="+startFrom), 
        };
